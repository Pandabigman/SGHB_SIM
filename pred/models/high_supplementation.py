...
class HighSupplementationModel(BaseModel):
    """Model 4: High supplementation with 10 SA captive birds per generation."""
    ...
    def run(self, Ne, generations, lambda_val=1.0, stochastic=False, genetic_data=None,
        ...
        """
        Run high supplementation model with dynamic captive breeding.
    ...
    def _run_with_csv_data(self, Ne, generations, lambda_val, stochastic, genetic_data, birds_per_gen,
        ...
        cache_key = get_cache_key(4, birds_per_gen, generations, Ne, stochastic) + "_breeding"
        ...
        # See low_supplementation.py for full explanation.
